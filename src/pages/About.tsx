...
const About = () => {
  return (
    <div>
      <CanonicalLink href="https://www.manage369.com/about" />
      ...
      <section className="py-20 bg-gradient-secondary text-white">
        <div className="container-max text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <a href="tel:847-834-4131" className="btn-outline border-white text-white hover:bg-white hover:text-secondary-500 text-lg px-10 py-4 font-semibold">
              Call (847) 834-4131
            </a>
          </div>
        </div>
